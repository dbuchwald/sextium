...
${BUILD_OBJ_DIR}/%.tab.o:${BUILD_GEN_DIR}/%.tab.c
	${CC} ${CC_FLAGS} -I${SOURCE_DIR} -c ${BUILD_GEN_DIR}/$*.tab.c -o ${BUILD_OBJ_DIR}/$*.tab.o

${BUILD_OBJ_DIR}/%.yy.o:${BUILD_GEN_DIR}/%.yy.c ${BUILD_GEN_DIR}/%.tab.c
